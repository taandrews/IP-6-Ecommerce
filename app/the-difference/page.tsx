    ...
    <>
      <article className="bg-cloud-100">
        ...
        <section className="container max-w-5xl pb-12">
          <div className="rounded-xl border border-cloud-300 bg-surface overflow-hidden shadow-soft">
            {/* Header row */}
            <div className="grid grid-cols-[1fr_1fr_1fr] border-b border-cloud-300 bg-cloud-100">
              <div className="p-5 lg:p-6">
                <p className="text-[10px] uppercase tracking-[0.28em] text-ink/55 font-bold">
                  Specification
                </p>
              </div>
              <div className="p-5 lg:p-6 border-l border-cloud-300">
              ...
              <div className="p-5 lg:p-6 border-l border-cloud-300 bg-navy-800 text-surface">
                <p className="text-[10px] uppercase tracking-[0.22em] text-gold-500 font-bold mb-1">
                  IP6 Original
                </p>
                <p className="text-xs text-surface/70">From the lab of Prof. Shamsuddin</p>
              </div>
            </div>
            ...
            {ROWS.map((row, i) => (
              ...
              >
                ...
                <div className="p-5 lg:p-6 border-l border-cloud-300 flex items-start gap-3">
                  <X className="size-4 text-ink/35 shrink-0 mt-0.5" aria-hidden />
                  <p className="text-sm text-ink/65">{row.commodity}</p>
                </div>
                <div className="p-5 lg:p-6 border-l border-cloud-300 bg-navy-800/95 text-surface flex items-start gap-3">
                  <Check className="size-4 text-sky-300 shrink-0 mt-0.5" aria-hidden />
                  <p className="text-sm text-surface/95 font-medium">{row.original}</p>
                </div>
              </div>
            ))}
          </div>
